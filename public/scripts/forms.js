...
const createCategoryCheckboxInEditModeForm = (categoryObj) => {
	const clone = document.querySelector("#categories-checkbox").content.cloneNode(true);
...
export { appendGameForm, appendCategoryForm, appendUserForm, appendCategoryEditModeForm };
